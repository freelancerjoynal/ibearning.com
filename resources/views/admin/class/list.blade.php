...
<br>
    <div class="class-list m-auto card p-3 justify-content-start">
        ...
        <div class="class">
            <div>{{$class['name']}}</div>
            <div>
                <a href="/web-admin/classes/delete/{{$class['id']}}" class="btn-sm btn-danger" onclick="return confirm('Are your sure to delete?') ">Delete</a>
                <a href="/web-admin/classes/edit/{{$class['id']}}" class="btn-sm btn-primary">Edit</a>
            </div>
            <hr>
        </div>
